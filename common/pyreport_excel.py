...
def yangshique(me):
	if me =='pass':
		...
		style.pattern=Pattern
	return style
def create(filename,list_pass,list_fail,listids,listnames,listTokens,listconeents,listurls,listfangshis,listqiwangs,list_json,listrelust):
    ...
    table1.write(1,2,'token',style=yangshi3())
    ...
    for i in range(len(listids)):
        ...
        table1.write(i+1, 2, listTokens[i],style=yangshi3())
        ...
        table1.write(i+1, 7, str(list_json[i])[0:500],style=yangshi3())
